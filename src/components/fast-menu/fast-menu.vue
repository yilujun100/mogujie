<template>
    <div class="c-fast-menu">
        <div class="c-fast-menu__mask" v-if="show" bga7></div>
        ...
        <div class="c-fast-menu__box">
            ...
            >
                ...
                <router-link to="/mall/home">
                    <c-button class="c-fast-menu__icon" bg-secondary circle>
            ...
            <c-button class="c-fast-menu__btn" @click="show = !show" mt26 circle bga7>
                快捷<br />导航
            </c-button>
