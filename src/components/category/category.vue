<template>
    <c-layout class="c-category" v-if="isShow">
        <c-header class="header">
            <c-box-skin type="bottom">
                <c-columns class="header__container">
                    <c-svg-left size="38" @click="hide" :colors="['#9c9c9c']"></c-svg-left>

                    <input class="header__input" v-model="des" pl10 radius6 />

                    <span @click="search" ph16 fz28 font-secondary>搜索</span>
                </c-columns>
            </c-box-skin>
        </c-header>
        ...
        <c-content>
            <c-box-skin class="c-category__content">
                <c-columns pa20>
                    <c-svg-star size="16" :colors="['#999', '#fff']" mr6></c-svg-star>
                ...
                <c-columns style="flex-wrap: wrap">
                    ...
                    >
                        <div class="c-category__goods" ph22 pv10 ml20 mb30 font-secondary radius6>
                            {{ item['title'] }}
                        </div>
                    </router-link>
                </c-columns>
