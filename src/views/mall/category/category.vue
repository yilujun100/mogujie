        ...
        <c-header fixed>
            <c-box-skin type="bottom">
                <c-columns pv6 pl10 pr20>
                    ...
                    <c-search class="search" @click="isShow = !isShow" text="连衣裙" radius2>
                    </c-search>
                </c-columns>
            </c-box-skin>
        </c-header>

        <c-layout class="content" horizontal>
            ...
            <c-content>
                <c-box-skin style="height: 100%; overflow: auto">
                    <c-row>
                        <c-col v-for="(item, index) in oneCategory" :key="index" span="8">
                            <router-link
                                :to="'/mall/goods?id=' + item['id'] + '&des=' + item['des']"
                            >
                                <c-avatar
                                    class="good"
                                    :url="item['image']"
