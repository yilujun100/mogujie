<template>
    <c-layout>
            ...
            <c-box-skin type="bottom">
                <c-columns>
                    <router-link to="/mall/category">
                        <c-svg-button size="30" :colors="['#c0c0c0']" ml30 mr20></c-svg-button>
                    </router-link>
                    <c-search
                        class="search"
                        @click="isShow = !isShow"
        ...
        <c-content>
            <c-box-skin>
                <!-- 促销活动 -->
                <c-row gutter="10" ph12 pv18>
                    <c-col v-for="(item, index) in promotionList" :key="index" span="6">
                        <router-link :to="item['path']">
                            <c-magazine class="promotion" :image="item['image']" radius4>
                ...
                <!-- 导航栏 -->
                <c-row class="nav" pb6>
                    <c-col v-for="(item, index) in categoryList" :key="index" span="4-8">
                        <c-avatar
                            class="nav__item"
            ...
            <!-- 商品列表 -->
            <c-row class="good" gutter="6" pa12>
                <c-col span="12">
                    <router-link
