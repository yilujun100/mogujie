<template>
    <c-layout>
        ...
        <c-content class="content">
            <c-box-skin>
                <div class="live" v-for="(item, index) in liveList" :key="index" ph24>
                    <router-link :to="'/live/detail?id=' + item['id']">
                        <c-magazine class="live__container" :image="item['background']">
                            <c-avatar
                                ...
                                pv18
                            ></c-avatar>
                            <c-button class="live__status" pl10 pr10 bga2 radius4
                                >直播中 | {{ item['watchNum'] }}</c-button
                            >
                            <span class="live__title" font-tertiary fz32>{{
                                item['liveTitle']
                            }}</span>
                            <c-columns>
                                <c-magazine
