<template>
    <div class="page">
        <header>
            <c-columns>
                <c-columns class="anchor" pa16 mt20 ml14 mb14 bga1 circle>
                    <c-avatar
        ...
        <div class="content" ml14>
            <c-button class="good" radius4 bga1>
                <c-magazine
                    ...
                    :image="item['image']"
                >
                    <c-button class="good__status">待秒杀</c-button>
                    <c-button class="good__price" pa6 bga7>{{ item['price'] }}</c-button>
                </c-magazine>
            </c-button>
        ...
        <footer class="footer">
            <c-columns class="footer__box" pt20 ph24 pb24>
                <c-columns>
                    <img
                        class="footer__img"
